function [CL,a,c,v,p] = fCn_p (CL,a,c,p,v)
...
a.Cn_p = -q1*tan(q2) - (- p.Cl_p * tan(alpha) - (q5)*(q3))+ q6*q7 + q8*q9*q10;
...
v.Cn_p = -(2/a.b) *(v.l*cos(c.alpha) + v.zmgc*sin(c.alpha))*((v.zmgc*cos(c.alpha)- v.l*sin(c.alpha))/v.b)*v.Cy_B;
